        ...
        <section className="space-y-8" data-testid="section-overview">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-purple-500/20 bg-purple-500/5">
              ...
              <CardContent>
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent">
                  1,000,000,000
                </div>
            ...
            <Card className="border-teal-500/20 bg-teal-500/5">
              ...
              <CardContent>
                <div className="text-4xl font-bold text-teal-400">9</div>
            ...
            <Card className="border-blue-500/20 bg-blue-500/5">
              ...
              <CardContent>
                <div className="text-4xl font-bold text-blue-400">Solana</div>
            ...
            <div className="space-y-4">
              <Card className="border-teal-500/20 bg-teal-500/5 hover-elevate">
                <CardHeader>
                  <CardTitle className="flex items-center justify-between text-foreground">
                    ...
                    <span className="text-2xl font-bold text-teal-400">40%</span>
                  </CardTitle>
                </CardHeader>
              ...
              <Card className="border-teal-500/20 bg-teal-500/5 hover-elevate">
                ...
                <CardContent className="space-y-2">
                  <div className="text-muted-foreground">150M X402</div>
                  <div className="w-full bg-black/50 rounded-full h-2">
                    <div className="bg-teal-400 h-2 rounded-full" style={{ width: '15%' }}></div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="relative w-full h-64 flex items-center justify-center">
                      <div className="text-center">
                        <div className="text-6xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent">
                          100%
                        </div>
            ...
            <Card className="border-purple-500/20 bg-purple-500/5">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 rounded-lg border border-purple-500/20 bg-purple-500/5">
                  <div className="text-4xl font-bold text-purple-400 mb-2">0.1%</div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3 rounded-lg border border-red-500/20 bg-red-500/5">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-xs font-semibold text-red-400">50% Burned</p>
                    </div>
                  ...
                  <div className="p-3 rounded-lg border border-teal-500/20 bg-teal-500/5">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-xs font-semibold text-teal-400">50% Treasury</p>
                    </div>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      <tr className="border-b border-teal-500/10">
                        ...
                        <td className="p-2 text-teal-400">$10k</td>
                      </tr>
                      <tr className="border-b border-teal-500/10">
                        <td className="p-2">2027</td>
                        <td className="p-2">$500M</td>
                        <td className="p-2 text-teal-400">$500k</td>
                      </tr>
                      <tr>
                        <td className="p-2">2028</td>
                        <td className="p-2">$5B</td>
                        <td className="p-2 text-teal-400">$5M</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
