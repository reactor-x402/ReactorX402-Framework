    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/10 to-black">
      <div className="max-w-4xl mx-auto px-8 py-24 space-y-16">
        ...
        <section className="space-y-6" data-testid="section-iot-growth">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            The global IoT market presents a <strong className="text-teal-400">$1.5 trillion opportunity by 2027</strong>, with key verticals experiencing explosive growth:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-purple-500/20 bg-purple-500/5">
              ...
              <CardContent className="space-y-2">
                <div className="text-3xl font-bold text-purple-400">$320B</div>
            ...
            <Card className="border-blue-500/20 bg-blue-500/5">
              ...
              <CardContent className="space-y-2">
                <div className="text-3xl font-bold text-blue-400">$280B</div>
            ...
            <Card className="border-teal-500/20 bg-teal-500/5">
              ...
              <CardContent className="space-y-2">
                <div className="text-3xl font-bold text-teal-400">$215B</div>
        ...
        <section className="space-y-6" data-testid="section-introducing-x402pay">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            <strong className="text-foreground">x402Pay</strong> solves these challenges by implementing the <strong className="text-teal-400">x402 protocol</strong> on Solana — the world's fastest blockchain with proven 40,000+ TPS throughput and sub-second finality.
          </p>
          
          <div className="p-8 rounded-xl border border-teal-500/30 bg-gradient-to-br from-teal-500/10 to-purple-500/10 backdrop-blur-sm space-y-4">
